...
void convert_fp32_to_fp16(half *dst, const float *src, size_t size);
void convert_fp16_to_fp32(float *dst, const half *src, size_t size);
void convert_fp32_to_bf16(__nv_bfloat16 *dst, const float *src, uint32_t size);
void convert_bf16_to_fp32(float *dst, const __nv_bfloat16 *src, uint32_t size);
...
void convert_int16_to_int8(int8_t* dst, const int16_t* src, size_t size);
void convert_int8_to_int16(int16_t* dst, const int8_t* src, size_t size);
} // namespace ape