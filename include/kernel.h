...
void create_mask_a(const float *src, size_t m, size_t k, ApeTrans transa, int *mask);
void create_mask_b(const float *src, size_t k, size_t n, ApeTrans transb, int *mask);
